...
## 3. DORA Metrics 대시보드 (시안)
지표의 시각화 및 가독성을 위해 아래와 같이 리포트를 구성하였습니다.

| 지표 (Metric) | 수치 (Value) | 상태 (Status) |
| :--- | :--- | :--- |
| Deployment Frequency | 1.2/day | High |
| Lead Time for Changes | 30m | Elite |
| Change Failure Rate | 5% | High |
| Time to Restore Service | 15m | Elite |
