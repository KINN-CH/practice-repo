...
철호님, 맞습니다! 이제 모든 준비는 끝났습니다. 3주차 README.md에 로봇이 지표를 배달해 줄 **'배달통(마커)'**만 설치하면 됩니다.

아래 내용을 week3/README.md 맨 아래에 추가하거나, 적당한 위치에 붙여넣어 주세요.

🛠️ week3/README.md 수정 (마커 추가)
기존 내용 맨 밑에 이 부분을 추가하세요:
...
| 지표 (Metric) | 수치 (Value) |
| :--- | :--- |
| Deployment Frequency | 데이터 수집 중... |
| Lead Time for Changes | 데이터 수집 중... |
| Change Failure Rate | 데이터 수집 중... |
| Time to Restore Service | 데이터 수집 중... |
<!-- END_DORA_METRICS -->